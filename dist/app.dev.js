...
dotenv.config(); //getstreamio import  

client = stream.connect('9yh73fspxyk4', 'gcdcvs2vfjwh7y9kuf3rybrmzw5jg43yzqv2a2qyyrv9jp9kq4krtmha9qqz79km', '81855'); // Instantiate a new client (client side)

client = stream.connect('9yh73fspxyk4', null, '81855'); // Find your API keys here https://getstream.io/dashboard/
...
app.use('/', authRouter);
app.use('/', indexRouter);
app.use('/', usersRouter); // Catch 404 and forward to error handler
